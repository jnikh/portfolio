    ...
    <div className='py-24 relative overflow-clip bg-[linear-gradient(to_bottom,#000,#2B1942_35%,#8F5C55_60%,#DBAF6E_80%)]'>
      ...
      <div className='relative'>
        <div className='text-8xl font-bold text-center'>
          ...
          <h1 className='text-[#E48A57]'>Nikhil Jha</h1>
        </div>
        <motion.div className='absolute md:block left-[280px] top-[170px]' drag>
            <Image
            src={cursor}
            height="190"
            width="190"
        ...
        <motion.div className='hiddem md:block absolute left-[220px] top-[20px]' drag>
            <Image
            src={lighting}
            height="190"
            width="190"
