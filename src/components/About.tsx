        ...
        <div className='absolute inset-0 bg-gradient-to-r from-orange-400 via-purple-700 to-orange-800 opacity-30 animate-gradient-xy'></div>
            ...
            <div  className='flex flex-row p-6'>
                ...
                <div className='flex flex-col mt-4'>
                    ...
                    <p className='text-1g text-white/70 mt-2'>I approach challenges with a logical/systematic mindset</p>
                </div>
            </div>
        ...
        <div className='absolute inset-0 bg-gradient-to-r from-orange-400 via-purple-700 to-orange-800 opacity-30 animate-gradient-xy'></div>
            ...
            <div  className='flex flex-row p-6'>
                ...
                <div className='flex flex-col mt-4'>
                    ...
                    <p className='text-1g text-white/70 mt-2'>Versatile in frontend and backend.</p>
                </div>
            </div>
        ...
        <div className='absolute inset-0 bg-gradient-to-r from-orange-400 via-purple-700 to-orange-800 opacity-30 animate-gradient-xy'></div>
            ...
            <div  className='flex flex-row p-6'>
                ...
                <div className='flex flex-col mt-4'>
                    ...
                    <p className='text-1g text-white/70 mt-2'>As a Fullstack Web Developer, I specialie in React js,Next js , Node js , Mongodb , Mysql. </p>
                </div>
            </div>
